...
import br.com.gpaiva.vendas.online.domain.Cliente;
import br.com.gpaiva.vendas.online.reources.ClienteResource;
import br.com.gpaiva.vendas.online.usecase.BuscaCliente;
import br.com.gpaiva.vendas.online.usecase.CadastroCliente;
...
public class ClienteResourceTest {
	...
	public void buscarPorId() {
		Cliente cliente1 = Cliente.builder().id("1").nome("Gilberto 1").build();
